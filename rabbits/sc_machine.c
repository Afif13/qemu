...
static void sc_qemu_machine_options(MachineClass *m) {
    m->desc = "Rabbits SystemC/QEMU machine";
    m->init = sc_qemu_machine_init;
    m->max_cpus = 128;
}

DEFINE_MACHINE("sc-qemu",sc_qemu_machine_options)
